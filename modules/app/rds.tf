...
#   database_name      = "emptio_db"   ### この名前で良い？
#   master_username    = "emptio_user" ###　この名前で良い？
#   master_password    = random_password.rds_password.result

#   backup_retention_period         = 5                     ### 自動バックアップ保持日数これで良い？
...
#   instance_class          = "db.t4g.medium" ### インスタンスクラスの希望はある？検証：db.t4g.medium, 本番：db.r6g.large
#   db_subnet_group_name    = aws_db_subnet_group.rds.name
...
#   family = "aurora-postgresql14" ### インスタンスのエンジンバージョンに合わせる
